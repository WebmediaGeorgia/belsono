...
(() => {
  ...
  function L(e) {
    ...
    if (c > i.longSwipesMs) {
      ...
      "next" === t.swipeDirection &&
        (w >= i.longSwipesRatio
          ? t.slideTo(i.rewind && t.isEnd ? g : u + b)
          : t.slideTo(u)),
  ...
  !(function (e) {
    ...
    new W(".doctors_slider_slider", {
      ...
      speed: 1e3,
      autoplay: { delay: 2500, disableOnInteraction: !0 },
      pagination: { el: ".doctors_slider-pagination", clickable: !0, dynamicBullets: !0,
      ...
      breakpoints: {
        0: { slidesPerView: 1 },
        601: { slidesPerView: 1.3 },
        1201: { slidesPerView: 2 },
      },
    });
  let Z = document.querySelector(".uslugi_all .btn"),
    ee = document.querySelector(".uslugi_all .blocks_usl");
  Z &&
    Z.addEventListener("click", () => {
      ee.classList.add("active"), Z.classList.add("hidden");
    }),
    new W(".otzyvySlider", {
      slidesPerView: 3,
      spaceBetween: 30,
      ...
      speed: 1e3,
      autoplay: { delay: 2500, disableOnInteraction: !0 },
      pagination: { el: ".my_otzyvy_slide_pagin", clickable: !0, dynamicBullets: !0,
      dynamicMainBullets: 5, },
      navigation: {
    ...
    new W(".all_centre_swiper", {
      ...
      loopFillGroupWithBlank: !0,
      modules: [X, U],
      pagination: { el: ".all_centre_slider-pagination", clickable: !0 },
      navigation: {
    ...
    new W(".mySert", {
      ...
      slidesPerGroup: 1,
      modules: [X, U],
      pagination: { el: ".mySert-pagination", clickable: !0 },
      navigation: { prevEl: ".mySert-prev", nextEl: ".mySert-next" },
      breakpoints: {
        1: { slidesPerView: 1 },
        601: { slidesPerView: 3.5, speed: 700, slidesPerGroup: 1, loop: !0 },
        1201: { slidesPerView: 5 },
      },
    });
  let te = document.querySelector(".btn_open"),
    se = document.querySelector(".content_member");
  te &&
    te.addEventListener("click", () => {
      se.classList.add("active"), te.classList.add("open");
    }),
    new W(".contacty_swiper_slider", {
      slidesPerView: 1,
      speed: 700,
      slidesPerGroup: 1,
      spaceBetween: 5,
      ...
      loopFillGroupWithBlank: !0,
      modules: [X, U],
      pagination: { el: ".contacty_slider-pagination", clickable: !0 },
      navigation: {
        nextEl: ".contacty_slider-next",
        prevEl: ".contacty_slider-prev",
      },
    }),
    new W(".swiper_other_news", {
      modules: [K],
      modules: [Q],
      slidesPerView: 4,
      spaceBetween: 30,
      ...
      slidesPerGroup: 1,
      modules: [X, U],
      pagination: { el: ".news_slider-pagination", clickable: !0 },
      navigation: { nextEl: ".news_slider-next", prevEl: ".news_slider-prev" },
      breakpoints: {
        1: {
          modules: [K],
          loop: !0,
        ...
        601: { slidesPerView: 2.6, loop: !0, loopFillGroupWithBlank: !0 },
        1201: { slidesPerView: 4 },
      },
    });
  const ie = document.querySelector(".icon-menu"),
    ne = document.querySelector(".burger_menu_top"),
    // ae = document.querySelector(".wrapper"),
    re = document.querySelectorAll(".nav_link_footer");
  ie &&
    (ie.onclick = function () {
      ie.classList.toggle("active"),
        ne.classList.toggle("active");
        // ae.classList.toggle("lock");
    }),
    re &&
      re.forEach((e) =>
